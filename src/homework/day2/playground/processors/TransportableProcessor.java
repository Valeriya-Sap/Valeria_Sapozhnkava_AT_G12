...
public class TransportableProcessor {
    public void runTransportable(Transportable transportable, int pointA, int pointB) {
        ...
        System.out.println(String.format("Transportable %s was moved to %d points", transportable.getClass().getSimpleName(), a));
    }
    ...
    public void runTransportable(Transportable transportable) {
        ...
        System.out.println(String.format("Transportable %s was moved to %d points", transportable.getClass().getSimpleName(), b));
    }
}
